...
import TeacherBabyUnitQuestions from '../BabyUnitQuestions/TeacherBabyUnitQuestions';


function TeacherBabyUnitDetail(){
...
function TeacherDetailBabyUnit() {
    ...
    <Page title="BabyUnitDetails">
        ...
        <Card id="UnitDetail">
                          ...
                          >
                            ...
                            <Grid item xs={3}>
                                <TeacherBabyUnitDetail/>
                            </Grid>   
                            
                          </Grid> 
                    
                    </Card>
                        <TeacherBabyUnitQuestions />
        </Stack>
...
export default TeacherDetailBabyUnit