...
function TeacherBabyUnit() {
  ...
  const handleDetailOnClick=(selectedBabyUnit)=>{
    navigate(`/Teacher/BabyUnit/${selectedBabyUnit.id}`,{state:selectedBabyUnit.row}); // to send exact row
}
const handleEditOnClick=(selectedBabyUnit)=>{
    navigate(`/Teacher/BabyUnit/Edit/${selectedBabyUnit.id}`,{state:selectedBabyUnit.row}); // to send exact values
}
...
export default TeacherBabyUnit