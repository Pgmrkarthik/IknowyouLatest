...
function TeacherBabyUnitQuestions() {
  ...
  const getTableValue = ()=>{
    ...
    const handleDetailOnClick=(selectedBabyUnit)=>{
        navigate(`/Teacher/BabyUnitQuestions/Detail/${selectedBabyUnit.id}`,{state:selectedBabyUnit.row}); // to send exact row
    }
    const handleEditOnClick=(selectedBabyUnit)=>{
        navigate(`/Teacher/BabyUnitQuestions/Edit/${selectedBabyUnit.id}`,{state:selectedBabyUnit.row}); // to send exact values
    }
        ...
        <Container>
                    <Card>
                          <Box
                            ...
                            >
                            <Button onClick={()=>{
                                navigate(`/Teacher/BabyUnitQuestions/Add`,{state:id});
...
export default TeacherBabyUnitQuestions