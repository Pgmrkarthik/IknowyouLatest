...
function AddTeacherBabyUnitQuestions() {
    ...
    const RegisterSchema = Yup.object().shape({
        Word: Yup.string().max(100, 'Too Long!').required('Word required'),
        ...
        <Container>
                    <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
                        <Typography variant="h5" gutterBottom>
                            ...
                            <Button variant="contained"  to={`/Teacher/BabyUnit/${id}`}  component={RouterLink} startIcon={<Iconify icon="bx:arrow-back" />}>
                            Back
                           </Button>
...
export default AddTeacherBabyUnitQuestions