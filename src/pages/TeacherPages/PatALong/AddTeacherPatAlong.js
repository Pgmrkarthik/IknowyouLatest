    ...
    const RegisterSchema = Yup.object().shape({
       ...
       const formik = useFormik({
        ...
        onSubmit: (Values) => {
          setLoading(true);
          console.log(Values)
          AddTeacherPatAlong(Values).then((response)=>{
                setLoading(false);
...
export default AddTeacherPatAlong